'use strict';
self._i = ['QQ群聊代码生成器', [1, 1, 0], 1638514418, 1654611814];
...
self.onload = function() {
  ...
  // color
  {
    document.getElementById('color-input').addEventListener('input', evt => {
  ...
  // gradient
  {
    /** @type {eg_package[]} */
    const gradients = [];
    document.getElementById('gradient-input').addEventListener('input', evt => {
    ...
    document.getElementById('gradient-preset').onclick = _evt => {
